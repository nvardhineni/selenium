...
public class SoftDeletedApplication extends LoginBase {
...
//		}
	...
	public void TestCase(String username, String password, String mfaUsername, String mfaPassword, String applicationId, String FFMSummary) throws InterruptedException{
...
//			}
	...
	try{	
		...
		//Thread.sleep(1000);
		WebElement FFMpopup=getElementByXPath("FFMpopupSummaryText");
		screenshot.pageScreenshot();
		 FFMText=FFMpopup.getText();
		 System.out.println(FFMText);
		 System.out.println(FFMpopup.getText());
		wait.until(ExpectedConditions.visibilityOf(getElementByXPath("cancelFFMChangesButton")));
		getElementByXPath("cancelFFMChangesButton").click();   
	}catch(NullPointerException e)
	{
...
//	getElementByXPath("AccountLogout").click();
		...
		public void reporterDataResults(){	
			...
			//If found Testfail = true, Result will be reported as FAIL against data set line In excel sheet.
				...
				SuiteUtility.WriteResultUtility(FilePath, TestCaseName, "FFMText", DataSet+1, FFMText);
				// enter actual result
