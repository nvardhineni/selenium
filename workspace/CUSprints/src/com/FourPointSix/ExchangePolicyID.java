...
public class ExchangePolicyID extends FourPointSixBase{
	...
	public void TestCase(String username, String password, String mfaUsername, String mfaPassword, String exchangeId ) throws InterruptedException{
		...
		try {
			...
			WebElement appId = (new WebDriverWait(driver, 40))
					.until(ExpectedConditions.presenceOfElementLocated(By.xpath(Object.getProperty("ExchangepolicyID")))); 

			appId.sendKeys(exchangeId);
			getElementByXPath("exchangepolicysearch").click();
			
			WebElement unlock = (new WebDriverWait(driver, 40))
					.until(ExpectedConditions.presenceOfElementLocated(By.xpath(Object.getProperty("Unlock"))));
