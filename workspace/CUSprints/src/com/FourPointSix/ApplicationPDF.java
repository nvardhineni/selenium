...
public class ApplicationPDF extends FourPointSixBase{
	...
	public void TestCase(String username, String password, String mfaUsername, String mfaPassword, String applicationId) throws InterruptedException{
		...
		try {
			...
			getElementByXPath("applicationPDF").click();
			Thread.sleep(10000);
		    ...
		    File recentlyDownloadedFile=getLatestFilefromDir(parameter.getProperty("downloadPath"));
		    System.out.println("recently dowloaded file name:"+recentlyDownloadedFile.getName());
		    System.out.println(recentlyDownloadedFile);
		    
		   
		    if(recentlyDownloadedFile.getName().contains(applicationId)&&recentlyDownloadedFile.exists())
		    {
		       ...
		       pdDoc = PDDocument.load(new File(recentlyDownloadedFile.getAbsolutePath()));
		        ...
		        Result=recentlyDownloadedFile.getName();
				if (pdDoc != null)
					pdDoc.close();
