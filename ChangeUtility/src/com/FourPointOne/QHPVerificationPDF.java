...
public class QHPVerificationPDF extends FourPointOneBase{
	...
	public void TestCase(String username, String password, String mfaUsername, String mfaPassword, String applicationId, String section) throws InterruptedException{
		    ...
		    if((recentlyDownloadedFile.exists())&&(recentlyDownloadedFile.getName().contains(applicationId)))
		    {
		    	...
		    	Wait.until(ExpectedConditions.numberOfWindowsToBe(2));
					...
					for(int i=0;i<numberOfPages;i++)
					{
						...
						pageNum=i;
						if(parsedText.contains(section))
						{
							Testfail=false;
							pageNum=i;
							break;
