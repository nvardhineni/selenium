...
public class TaxHHSize extends FivePointThreeBase {
	...
	public void TestCase(String username, String password, String mfaUsername, String mfaPassword, String applicationId, String segmentNum) throws InterruptedException{
		    ...
		    if((recentlyDownloadedFile.exists())&&(recentlyDownloadedFile.getName().contains(applicationId)))
		    {
		    	...
		    	Wait.until(ExpectedConditions.numberOfWindowsToBe(2));
					...
					for(int i=0;i<numberOfPages;i++)
					{
						...
						pageNum=i;
						if(parsedText.contains(parameter.getProperty("taxhouseholdSize")))
						{
							Testfail=false;
							pageNum=i;
							break;
		            ...
		            Thread.sleep(1000);
		             ...
		             Thread.sleep(5000);
						if (pdDoc != null)
							pdDoc.close();
						String[] texts = parsedText.split(parameter.getProperty("taxhouseholdSize"));
						System.out.println(texts[1]);
						String text = texts[1].substring(1, 3);
						Result=text;
				System.out.println("Tax Household size  is :"+ Result);
